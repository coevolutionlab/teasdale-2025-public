...
rule longORF:
    ...
    shell:
        ...
        touch {input.check}
        cd {params.path}
        /ebio/abt6/lvaness/software/TransDecoder-TransDecoder-v5.7.0/TransDecoder.LongOrfs --complete_orfs_only -t {params.fasta} > ../../../../{log}
        cd ../../../../
        touch {output}
        """
...
rule predictORF:
    ...
    shell:
        ...
        touch {input.check}
        cd {params.path}
        /ebio/abt6/lvaness/software/TransDecoder-TransDecoder-v5.7.0/TransDecoder.Predict -t {params.fasta} > ../../../../{log}
        cd ../../../../
        touch {output}
        """
