...
genome="/ebio/abt6_projects7/diffLines_20/data/Adrian_TIPs/data/genomes/at9762/at9762.scaffolds.bionano.final_mod.fasta"

perl ${EDTA} --threads 25 --genome ${genome} \
--cds ${cds} \
--sensitive 1 \
--anno 1   \
--evaluate 1 \
