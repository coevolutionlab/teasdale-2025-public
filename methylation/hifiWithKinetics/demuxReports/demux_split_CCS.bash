#!/bin/bash
lima at9336_at9762.hifi_withKinetics.bam Sequel_16_Barcodes_v3.fasta at9336_at9762.hifi_withKinetics.demux.bam --hifi-preset SYMMETRIC --split-bam --split-named --split-subdirs
