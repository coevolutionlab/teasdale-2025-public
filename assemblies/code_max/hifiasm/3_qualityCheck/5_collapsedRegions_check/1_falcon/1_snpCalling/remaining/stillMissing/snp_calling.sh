...
for i in $(ls at*.scaffolds.fasta); do
	...
	bcftools mpileup --threads 125 -D -Q5 --max-BQ 50 -F0.1 -o25 -e1 --delta-BQ 10 -M99999 -f ../$i ../$NAME.mappings.falcon.scaffolds.sorted.bam | bcftools call -mv -Ob -o $NAME.calls.bcf &
	cd ../
done
