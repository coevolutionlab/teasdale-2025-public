...
--genomeDir /tmp/global2/mcollenberg/data/diff_lines/hifiasm/6_gene_annotation/3_rnaSeq_mappings/1_starIndices/at9744_starIndex \
...
--outFileNamePrefix hybridNecrosis_at9744
